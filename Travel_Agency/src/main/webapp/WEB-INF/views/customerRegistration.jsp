...
<html lang="en-US">
    <head>
        ...
        <script src="../../static/js/controller/customer_controller.js" type="text/javascript"></script>
...
<!--        <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/css/bootstrap.min.css">
    ...
    <body ng-app="myApp">
        <div ng-controller="AddCustomerController as objCtrl">
            <h1>Customer Info </h1>
            <form name="objForm" method="POST">
                <table>
                    <tr><td colspan="2">
                            ...
                            <div ng-if="objCtrl.flag == 'edit'">
                                <h3> Update Customer for ID: {{ objCtrl.obj.@custId}} </h3> 
                            </div> </td>
                    </tr>
                    <tr>
                    ...
                    <tr><td colspan="2">
                            <div ng-if="objCtrl.flag != 'edit'">
                                <input  type="submit" ng-click="objCtrl.addCustomer()" value="Add Customer"/> 
                                <input type="button" ng-click="objCtrl.reset()" value="Reset"/>
                            </div>
                            <div ng-if="objCtrl.flag == 'edit'">
                                <input  type="submit" ng-click="objCtrl.updateCustomerDetail()" value="Update Customer"/> 	
            ...
            <table>
                <tr><th>ID </th> <th>First_Name</th> <th>Last_Name</th>  <th>Address</th> <th>Mobile</th>  <th>Email</th> <th>User_name</th> <th>Password</th></tr>
                <tr ng-repeat="row in objCtrl.objArray">
                    <td><span ng-bind="row.custId"></span></td>
                    ...
                    <td>
                        <input type="button" ng-click="objCtrl.deleteCustomer(row.custId)" value="Delete"/>
                        <input type="button" ng-click="objCtrl.editCustomer(row.custId)" value="Edit"/>
                        <span ng-if="objCtrl.flag == 'updated' && row.custId == objCtrl.updatedId" class="msg-success">Customer successfully updated.</span> </td> 
                </tr>	
            </table>
        </div>
